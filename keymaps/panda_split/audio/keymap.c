...
[_ADJUST] = LAYOUT( \
            DF(_QWERTY), ____, DF(_EUCALYN), ____, ____,    MU_TOG, ____, KC_PSCR, KC_VOLU, RESET,
            AU_ON, ____, DF(_EUCALYN), ____, ____,           ____, DF(_QWERTY_J), KC_INS, KC_VOLD, ____,
            AU_OFF, ____, ____, ____, ____,                   ____, ____, ____, ____, ____,
